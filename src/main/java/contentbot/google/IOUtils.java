...
public class IOUtils {
     ...
     * @throws IOException
     */
    public static void writeAll(final String data, final OutputStream outputStream, final Charset charset)
            throws IOException {
     ...
     * @throws IOException
     */
    public static void writeAll(final String data, final OutputStream outputStream, final String charset)
            throws IOException {
     ...
     * @throws IOException
     */
    public static void writeAll(final String data, final OutputStream outputStream) throws IOException {
     ...
     * @throws IOException
     */
    public static String readAll(final InputStream inputStream, final Charset charset) throws IOException {
     ...
     * @throws IOException
     */
    public static String readAll(final InputStream inputStream, final String charset) throws IOException {
     ...
     * @throws IOException
     */
    public static String readAll(final InputStreamReader streamReader) throws IOException {
    ...
    private static long copy(final Reader reader, final Writer writer, final char[] buffer) throws IOException {
        assert buffer != null;
