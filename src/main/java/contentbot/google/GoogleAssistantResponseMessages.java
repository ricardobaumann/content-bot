...
public abstract class GoogleAssistantResponseMessages extends ResponseMessage {
    ...
    protected GoogleAssistantResponseMessages(final MessageType type) {
    ...
    public static class OptionInfo {
         ...
         */
        public final void setSynonyms(final List<String> synonyms) {
    ...
    public static class CardItem {
         ...
         */
        public final void setOptionInfo(final OptionInfo optionInfo) {
         ...
         */
        public final void setImage(final CardImage image) {
            this.image = image;
        }
    }
    ...
    public static class ResponseChatBubble extends GoogleAssistantResponseMessages {
         ...
         */
        public final void setCustomizeAudio(final Boolean customizeAudio) {
        ...
        public static class Item {
             ...
             */
            public final void setTextToSpeech(final String textToSpeech) {
             ...
             */
            public final void setSsml(final String ssml) {
                this.ssml = ssml;
            }
    ...
    public static class ResponseBasicCard extends GoogleAssistantResponseMessages {
         ...
         */
        public final void setFormattedText(final String formattedText) {
         ...
         */
        public final void setButtons(final List<Button> buttons) {
        ...
        public static class Button {
             ...
             */
            public final void setOpenUrlAction(final OpenUrlAction openUrlAction) {
    ...
    public static class ResponseListCard extends GoogleAssistantResponseMessages {
         ...
         * @param items the items to set
         */
        public final void setItems(final List<CardItem> items) {
            this.items = items;
        }
    }
